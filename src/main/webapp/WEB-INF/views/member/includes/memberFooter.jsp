			...
			<div class="row">
				<div class="col-xl-3 col-md-6 col-sm-6 col-12">
					<div class="footer-widget footer-about-widget">
						<div class="footer-logo">
							<div class="site-logo">
								<img src="/resources/member/img/logo-2.png" alt="Logo">
							</div>
						</div>
						<p>Lorem Ipsum is simply dummy text of the and typesetting
							industry. Lorem Ipsum is dummy text of the printing.</p>
				...
				<div class="col-xl-3 col-md-6 col-sm-12 col-12">
					<div class="footer-widget footer-newsletter-widget">
						...
						<p>Subscribe to our weekly Newsletter and receive updates via
							email.</p>
						...
						<img src="/resources/member/img/icons/payment-4.png"
							alt="Payment Image">
					</div>
				</div>
			</div>
