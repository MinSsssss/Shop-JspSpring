		...
		<div class="card-body">
					...
					<tbody>
						<tr>
							...
							<td class="align-middle readOnlyText">
								<input class="readOnlyText" type="text" value="${qna.qna_status}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>분류</th>
							<td class="align-middle readOnlyText">
								<input class="readOnlyText" type="text" value="${qna.category_name}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>작성자</th>
							<td class="align-middle readOnlyText">
								<input class="readOnlyText" type="text" value="${qna.qna_writer}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>전화번호</th>
							<td class="align-middle readOnlyText">
								<input class="readOnlyText" type="text" value="${qna.qna_tel}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>주문번호</th>
							<td class="align-middle readOnlyText">
								<a href="/admin/order/orderDetailView?order_no=${qna.order_no}">${qna.order_no}</a>
							</td>
						</tr>
						<tr>
							<th>제목</th>
							<td class="align-middle readOnlyText">
								<input class="readOnlyText" type="text" value="${qna.qna_title}" readonly="readonly">
							</td>
						</tr>
						<tr>
							<th>내용</th>
							...
							rows="" cols="" readonly="readonly">${qna.qna_content}</textarea> 
							</td>
						</tr>			
					</tbody>
				</table>
			...
			<c:choose>
				...
				<c:when test="${qna.qna_status eq '답변 완료'}">
					<h4>작성하신 답변</h4>
					<textarea class="readOnlyText"
							rows="" cols="" readonly="readonly">${qna.qna_answer}</textarea> 
				</c:when>
			</c:choose>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="qnaDeleteModalTitle">FAQ삭제</h5>
